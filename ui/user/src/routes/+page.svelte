...
{#snippet unauthorizedContent()}
	<div class="relative w-full flex-col text-black dark:text-white">
		...
		<dialog
			...
			class="fixed top-1/2 left-1/2 m-0 h-auto max-h-none w-full max-w-none -translate-x-1/2 -translate-y-1/2 rounded-none p-4 shadow-lg backdrop:bg-black/50 md:max-h-fit md:max-w-md md:rounded-3xl"
		>
